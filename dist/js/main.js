...
var counter = 1;
var maxSpeed = 100;
var minSpeed = 10; // Enemies our player must avoid
...
var Enemy = function Enemy(x, y) {
  ...
  this.x = x;
  this.y = y;
  this.speed = 3 + Math.floor(Math.random() * (maxSpeed - minSpeed) + minSpeed); // The image/sprite for our enemies, this uses
...
function () {
  ...
  _createClass(Player, [{
    ...
    key: "handleInput",
    value: function handleInput(press) {
...
var allEnemies = [];
var loction = [55, 140, 218];
loction.forEach(function (loctionY) {
  newEnemy = new Enemy(0, loctionY);
  allEnemies.push(newEnemy);
});
var player = new Player(200, 407); // This listens for key presses and sends the keys to your
